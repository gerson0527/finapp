-- Solo generar recurrentes del mes en curso (evita recrear movimientos borrados en meses pasados)
...
BEGIN
  ...
  LOOP
    ...
    IF tpl.type = 'expense' THEN
      UPDATE accounts SET balance = balance - tpl.amount WHERE id = tpl.account_id AND user_id = v_user_id;
